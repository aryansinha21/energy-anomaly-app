...
import sys
sys.path.insert(0, '/energy-anomaly-app')
...
# MAIN CONTENT AREA
# ===========================
st.markdown("# ⚡ Smart Energy Anomaly Detection System")
st.markdown("Detect and analyze anomalies in energy consumption using machine learning")
